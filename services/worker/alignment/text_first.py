...
_REPEAT_GAP_S   = 2.0   # seconds — gaps narrower than this are pauses, not repeats
_REPEAT_MIN_W   = 3     # minimum words in gap to attempt matching (filters hallucinations)
